...
$redux_base = $vendor_dir . 'redux-framework/';

if ( !class_exists( 'ReduxFramework' ) && file_exists( dirname( __FILE__ ) . $redux_base . 'ReduxCore/framework.php' ) ) {
    require_once( dirname( __FILE__ ) . $redux_base . 'ReduxCore/framework.php' );
}
if ( !isset( $redux_demo ) && file_exists( dirname( __FILE__ ) . '/inc/redux-options.php' ) ) {
...
if ( !class_exists( 'cmb_Meta_Box' ) ) {
    define('CMB_URL',get_template_directory_uri().'/vendor/Custom-Meta-Boxes/');
    require_once( 'vendor/Custom-Meta-Boxes/custom-meta-boxes.php' );
...
// Essence for oembeds
//require_once('vendor/essence/lib/Essence/Provider.php');
...
if( !function_exists("theme_styles") ) {
    function theme_styles() {
        if (!is_admin()){
            ...
            wp_register_style( 'blueimp-gallery-css', get_template_directory_uri() . '/vendor/Gallery/css/blueimp-gallery.min.css', array(), '2.12.1', 'all' );
            wp_register_style('tocify-css',get_template_directory_uri() . '/vendor/jquery.tocify.js/src/stylesheets/jquery.tocify.css', array(), '1.9.0', 'screen');
...
if( !function_exists( "theme_js" ) ) {
  function theme_js(){
      ...
      //use CDN for loading Bootstrap
        wp_register_script('bootstrap-js', '//netdna.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js', array('jquery'), '3.3.5', true);
        //wp_register_script( 'wpbs-scripts', get_template_directory_uri() . '/js/scripts.js',array('jquery'),'3.1', true );
        ...
        wp_register_script('blueimp-gallery-js', get_template_directory_uri() . '/vendor/Gallery/js/jquery.blueimp-gallery.min.js', array('jquery'), '2.14.0', true);
        wp_register_script('blueimp-gallery-init-js', get_template_directory_uri() . '/js/wp-gallery.min.js', array('jquery','blueimp-gallery-js'), false, true);
        wp_register_script('jquery-ui','//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js', array('jquery'), '1.10.3', true);
        wp_register_script('tocify-js',get_template_directory_uri() . '/vendor/jquery.tocify.js/src/javascripts/jquery.tocify.min.js', array('jquery','jquery-ui'), '1.9.0', true);
        wp_register_script( 'shuffle', get_template_directory_uri() . '/js/wp-shuffle.min.js', array('jquery'), '2.1.2', true);
        ...
        // ajax functions
        wp_register_script( 'admin_ajax', get_template_directory_uri() . '/js/wp-admin.min.js', array('jquery'), '0.1', false );
